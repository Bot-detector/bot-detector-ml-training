...
class hiscoreData:
    ...
    def __skill_ratio(self):
        ...
        This method will:
            ...
            - fill na with 0
        """
        self.skill_ratio = cudf.DataFrame(index=self.df_clean.index)
    ...
    def __boss_ratio(self):
        ...
        This method will:
            ...
            - fill na with 0
        """
        self.boss_ratio = cudf.DataFrame(index=self.df_clean.index)
    ...
    def features(
        ...
        """
        features = cudf.DataFrame(index=self.df_clean.index)
        if base:
...
class playerData:
    ...
    def __init__(self, player_data: List[dict], label_data: List[dict]) -> None:
        ...
        """
        self.df_players = cudf.DataFrame(player_data)
        self.df_labels = cudf.DataFrame(label_data)
        self.__clean()
